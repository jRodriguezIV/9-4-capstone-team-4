  ...
  return (
    <div>
      ...
      <div className="w-screen h-screen relative">
        <div className="h-[90%] max-[760px]:h-auto shadow-2xl overflow-hidden">
          <img
            src={image2}
            alt="WanderLust"
      ...
      <div className="h-screen pt-20">
        <div className="bg-blackbg h-5/6  max-[760px]:w-screen max-[760px]:mt-[15%] max-[760px]: mx-40 max-[760px]:mx-0 max-[760px]:r-0 rounded-3xl shadow-2xl">
